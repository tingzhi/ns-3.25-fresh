 ...
 */
#ifndef GOSSIP_UDP_CLIENT_SERVER_HELPER_H
#define GOSSIP_UDP_CLIENT_SERVER_HELPER_H
...
public:
   ...
   */
  GossipUdpServerHelper (uint16_t port);
   ...
   */
  Ptr<GossipUdpServer> GetServer (void);
private:
  ObjectFactory m_factory; //!< Object factory.
  Ptr<GossipUdpServer> m_server; //!< The last created server application
};
...
public:
  ...
  GossipUdpClientHelper (Ipv4Address ip, uint16_t port);
  /**
   *  Create UdpClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
  ...
  GossipUdpClientHelper (Ipv6Address ip, uint16_t port);
  /**
   *  Create UdpClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
  ...
  GossipUdpClientHelper (Address ip, uint16_t port);
...
*/
//class GossipUdpTraceClientHelper
//{
//public:
//  /**
...
//   */
//  GossipUdpTraceClientHelper (Address ip, uint16_t port, std::string filename);
//  /**
//   * Create UdpTraceClientHelper which will make life easier for people trying
//   * to set up simulations with udp-client-server.
//   *
...
//   * \param filename the file from which packet traces will be loaded
//   */
//  GossipUdpTraceClientHelper (Ipv4Address ip, uint16_t port, std::string filename);
//  /**
//   * Create UdpTraceClientHelper which will make life easier for people trying
//   * to set up simulations with udp-client-server.
//   *
...
//   * \param filename the file from which packet traces will be loaded
//   */
//  GossipUdpTraceClientHelper (Ipv6Address ip, uint16_t port, std::string filename);
//
//  /**
//    * Record an attribute to be set in each Application after it is is created.
//    *
...
#endif /* GOSSIP_UDP_CLIENT_SERVER_H */
