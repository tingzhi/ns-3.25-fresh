...
#ifndef GOSSIP_HELPER_H
#define GOSSIP_HELPER_H
...
public:
   ...
   */
  Ptr<Gossip> GetGenerator (void);
private:
  ObjectFactory m_factory; //!< Object factory.
  Ptr<Gossip> m_generator; //!< The last created generator application
};

} // namespace ns3

#endif /* GOSSIP_HELPER_H */
