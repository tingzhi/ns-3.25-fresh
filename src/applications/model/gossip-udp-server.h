...
#ifndef GOSSIP_UDP_SERVER_H
#define GOSSIP_UDP_SERVER_H
 ...
 */
class GossipUdpServer : public Application
{
public:
  /**
...
private:
  ...
  std::vector<Ipv4Address> m_StoreAck;
  uint32_t m_NodeNumber;
  bool m_broadcastStatus;
};

} // namespace ns3

#endif /* GOSSIP_UDP_SERVER_H */
